...
const AddReview = ({navigation, route}) => {
  ...
  const handleUpdateEmail = async (values) => {
    try {
      const response = await fetch('http://192.168.1.103:3000/review/postReview', {
        method: 'POST',
        headers: {
      ...
      Alert.alert('Sukces', 'Pomyślnie dodano opinię');
